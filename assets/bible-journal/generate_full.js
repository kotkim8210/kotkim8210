...
// ---------- renderers ----------
function rCover() { const { c, x } = page(); frame(x, 70); spaced(x, 'PRAYER JOURNAL', W / 2, 470, 34, 'NMR', INK_SOFT, 16); sprig(x, W / 2, 760, 1.7, INK); const t = '엄마의 기도 노트'; center(x, t, W / 2, 1130, fit(x, t, W - M * 2 - 120, 168, 'NMX'), 'NMX', INK); rule(x, W / 2 - 120, 1210, W / 2 + 120, INK_SOFT, 2.5); center(x, '자녀를 위한 기도 저널', W / 2, 1320, 60, 'NMR', INK_SOFT); center(x, '쉬지 말고 기도하라', W / 2, 2050, 50, 'NMR', INK); center(x, '데살로니가전서 5 : 17', W / 2, 2120, 38, 'NMR', INK_SOFT); return c; }
