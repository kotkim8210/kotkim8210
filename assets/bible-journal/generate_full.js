...
// ---------- renderers ----------
function rCover() { const { c, x } = page(); frame(x, 70); spaced(x, 'PRAYER JOURNAL', W / 2, 455, 44, 'NMR', INK_SOFT, 22); sprig(x, W / 2, 770, 1.7, INK); const t = '엄마의 기도 노트'; center(x, t, W / 2, 1140, fit(x, t, W - M * 2 - 120, 168, 'NMX'), 'NMX', INK); rule(x, W / 2 - 130, 1220, W / 2 + 130, INK_SOFT, 2.5); center(x, '자녀를 위한 기도 저널', W / 2, 1335, 84, 'NMB', 'rgba(84,96,63,0.92)'); center(x, '쉬지 말고 기도하라', W / 2, 2025, 70, 'NMB', INK); center(x, '데살로니가전서 5 : 17', W / 2, 2120, 48, 'NMR', INK_SOFT); return c; }
