...
- [[school-cleaning-market]] — ⚠️**중대 정정됨**. 금액의 53%가 상위 10%(N교 묶음발주 3~5천만원)에 집중. 1인수의=입찰없음=**검색·블로그가 영업 채널**. `#시장조사 #청소업 #실측 #정정`
...
- [확인필요] 서울·경기에도 인천 학교지원단 같은 **묶음발주 주체**가 있는지 미확인. 서울 학교 수는 인천의 3배 이상 — 시장 규모 재산출 필요.
